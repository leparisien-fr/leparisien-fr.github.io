...
var Ia={},Ha={};var Ja=String.prototype.trim?function(a){return a.trim()}:function(a){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(a)[1]},Ka=/&/g,La=/</g,Ma=/>/g,Na=/"http://www.leparisien.fr/g,Oa=/'/g,Pa=/\x00/g,Qa=/[\x00&<>"']/;var D;a:{var Ra=m.navigator;if(Ra){var Sa=Ra.userAgent;if(Sa){D=Sa;break a}}D=""}function E(a){return-1!=D.indexOf(a)}
...
;var rb=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^\\/?#]*)@)?([^\\/?#]*?)(?::([0-9]+))?(?=[\\/?#]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;function sb(a){var b=a.match(rb);a=b[1];var c=b[2],d=b[3];b=b[4];var e="";a&&(e+=a+":");d&&(e+="http://www.leparisien.fr//",c&&(e+=c+"@"),e+=d,b&&(e+=":"+b));return e}
...
Oc.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,w()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Yb(b))}catch(f){return}else e=escape(b);b=this.g;mb.set(""+a,e,{I:c,path:"http://www.leparisien.fr/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
Oc.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;mb.remove(""+a,"http://www.leparisien.fr/",void 0===b?"youtube.com":b)};new Oc;function X(a,b,c){this.l=this.f=this.g=null;this.j=qa(this);this.h=0;this.v=!1;this.s=[];this.i=null;this.L=c;this.M={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?sb(a.src):"https://www.youtube.com"),this.g=new Gc(b),c||(b=Pc(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+qa(this.f)),S[this.f.id]=this,window.postMessage){this.i=new J;Qc(this);b=U(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
...
la(Y,X);g=Y.prototype;g.C=function(){return"http://www.leparisien.fr/embed/"+U(this.g,"videoId")};
...
la(Z,X);Z.prototype.C=function(){return"http://www.leparisien.fr/embed/"+U(this.g,"videoId")};
